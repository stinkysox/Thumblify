              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {thumb.isGenerating && (
                      <div className="absolute inset-0 bg-black/50 flex items-center justify-center text-sm text-white font-medium">
                        Generating...
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-4 space-y-2">
                    <h3 className="text-sm font-medium line-clamp-2 text-zinc-200">
                      {thumb.title}
                    </h3>
                  ...
                  <div
                    ...
                    className="absolute bottom-2 right-2 hidden sm:group-hover:flex gap-1.5"
                  >
                    <TrashIcon
